...
public class TablaRhDto {
    ...
    public TablaRhDto(Long docente_id,
                      String nombre,
                      String rfc,
                      String curp,
                      String correo,
    ...
    public void setFechaIng(String vigenciaDocente) {
        this.vigenciaDocente = vigenciaDocente;
    }
    ...
    public void setValidacion(String validacion) {Validacion = validacion;}
}

...
import com.siget.siget20.Services.Login.SolicitudDesarrolloAcademicoService;
...
@Service("solicitudDesarrolloAcademicoServiceImp")
public class SolicitudDesarrolloAcademicoServiceImp implements SolicitudDesarrolloAcademicoService {
    ...
    public List<SolicitudRhDto> SolicitudDesarrollo() {
        ...
        for (Solicitud solicitud : solicitudes) {
            ...
            if (!"Desarrollo Academico".equalsIgnoreCase(solicitud.getAreaDestino())) {
                continue;
            }
    ...
    @Override
    public void aprobarSolicitudDesarrollo(Long solicitudId) {
    ...
    @Override
    public void rechazarSolicitudDesarrollo(Long solicitudId) {
        Solicitud solicitud = solicitudRepository.findById(solicitudId)
                .orElseThrow(() -> new IllegalArgumentException("Solicitud no encontrada"));
